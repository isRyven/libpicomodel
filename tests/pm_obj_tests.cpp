...
TEST_CASE("Should load simple obj") {
	picoModel_t *model = PicoLoadModel("../tests/assets/model.obj", 0);
	REQUIRE(model != NULL);
	PicoFreeModel(model);
}

TEST_CASE("Should correctly parse simple obj") {
	picoModel_t *model = PicoLoadModel("../tests/assets/model.obj", 0);
	...
	picoVec2_t sts[] = { { 1.f, 0.f },{ 0.f, -1.f },{ 0.f, 0.f },{ 1.f, 0.f }, {1.f, -1.f}, {0.f, -1.f} };
